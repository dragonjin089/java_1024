...
DROP TABLE IF EXISTS `mobie_genre`;

CREATE TABLE `mobie_genre` (
...
ALTER TABLE `mobie_genre` ADD CONSTRAINT `FK_movie_TO_mobie_genre_1` FOREIGN KEY (
	`mg_mo_num`
)
REFERENCES `movie` (
	`mo_num`
...
ALTER TABLE `mobie_genre` ADD CONSTRAINT `FK_genre_TO_mobie_genre_1` FOREIGN KEY (
	`mg_ge_name`
)
REFERENCES `genre` (
	`ge_name`
