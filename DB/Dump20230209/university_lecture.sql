...
CREATE TABLE `lecture` (
  ...
  PRIMARY KEY (`le_num`),
  KEY `FK_professor_TO_lecture_1` (`le_pr_num`),
  CONSTRAINT `FK_professor_TO_lecture_1` FOREIGN KEY (`le_pr_num`) REFERENCES `professor` (`pr_num`)
...
INSERT INTO `lecture` VALUES (1,'컴퓨터 개론','월1,2',3,1,2022,'1','2022160001'),(2,'자바','화1,2,3,4',3,1,2022,'1','2022160002'),(5,'html','월 3,4',2,1,2022,'2','2022160002');
