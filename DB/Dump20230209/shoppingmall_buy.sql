...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `insert_buy` AFTER INSERT ON `buy` FOR EACH ROW -- 각 행마다 적용
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `UPDATE_BUY` AFTER UPDATE ON `buy` FOR EACH ROW BEGIN
-- 제품 수량을 변경 
...
-- Dump completed on 2023-02-09 21:36:34
