...
CREATE TABLE `member` (
  ...
  `me_name` varchar(15) DEFAULT NULL,
...
INSERT INTO `member` VALUES ('abc','abc','ABC마트',NULL,'MEMBER',0),('admin','admin','관리자 ',NULL,'ADMIN',0),('hi','hi','고길동','2002-12-12','MEMBER',0),('qwe','qwe','홍길동','2000-02-01','MEMBER',0);
