...
private DBConnector dbConnector;
	...
	public LectureVO selectLectureByName(String le_name, int le_class, int le_year, String le_term) {
		String sql = "select le_num, le_name, le_schedule, le_point, le_class, le_year, le_term ,le_pr_num from lecture where le_name=? and le_class=? and le_year=? and le_term=?";
		try {
			dbConnector.pstmt = dbConnector.con.prepareStatement(sql);
