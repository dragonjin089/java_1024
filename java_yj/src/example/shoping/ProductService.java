...
public interface ProductService {
	 ...
	 * 판매가 구매가 final로 인한 변경
	 * 	 */
	boolean updateProdcut(List<Product> productList,int index,Product product);
	/** 기존 제품 정보를 삭제하는 메소드
	 * @param productList 제품 리스트 
	...
	/**제품 리스트에서 index 번지에있는 제품을 가져오는 메소드
	 * @param productList 제품 리스트 
	 * @param index 가져올 번지 
	...
	/**제품 수량을 변경하는 매소드
	 * @param product 제품 정보
	 * @param amount 제품tnfid ( +면 제품을 구매 , -면 제품을 판매 
	 * */
