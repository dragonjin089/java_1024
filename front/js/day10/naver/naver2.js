$(function(){
	...
	$('.box-body-right2').hover(function(){
		...
		rollingRight2 = rollingLeft(rollingOBjRigh2.li,rollingRigh2.ul,rollingOBjRigh2.time,rollingOBjRigh2.duration);
	});
});
...
function rollingTop(rollingObj){
  return setInterval(moveTop,rollingObj.duration,rollingObj.liSelector,rollingObj.ulSelector, rollingObj.animationTime);
}
